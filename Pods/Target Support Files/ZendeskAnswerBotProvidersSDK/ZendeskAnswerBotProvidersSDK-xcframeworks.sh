...
install_xcframework "${PODS_ROOT}/ZendeskAnswerBotProvidersSDK/AnswerBotProvidersSDK.xcframework" "ZendeskAnswerBotProvidersSDK" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"

...
install_xcframework "${PODS_ROOT}/ZendeskChatProvidersSDK/ChatProvidersSDK.xcframework" "ZendeskChatProvidersSDK" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"

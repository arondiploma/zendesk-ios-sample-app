...
install_xcframework "${PODS_ROOT}/ZendeskMessagingAPISDK/MessagingAPI.xcframework" "ZendeskMessagingAPISDK" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"

...
install_xcframework "${PODS_ROOT}/ZendeskSDKConfigurationsSDK/SDKConfigurations.xcframework" "ZendeskSDKConfigurationsSDK" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"

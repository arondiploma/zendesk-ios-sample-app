...
install_xcframework "${PODS_ROOT}/ZendeskSupportProvidersSDK/SupportProvidersSDK.xcframework" "ZendeskSupportProvidersSDK" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
